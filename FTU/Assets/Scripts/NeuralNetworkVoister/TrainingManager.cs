...
public class TrainingManager : MonoBehaviour
{
    ...
    public void InitNetworks()
    {
        ...
        for (int i = 0; i < populationSize; i++)
        {
            ...
            net.Load("Assets/ModelSaveMove.txt");//on start load the network save
            networks.Add(net);
        }
    }
    ...
    public void CreateVoisters()
    {
        ...
        if (voisters != null)
        {
            ...
            {
                GameObject.Destroy(voisters[i].gameObject);//if there are Prefabs in the scene this will get rid of them
            }
        ...
        for (int i = 0; i < populationSize; i++)
        {
            ...
            VoisterBehaviour voister = (Instantiate(prefab, randomPos, new Quaternion(0, 0, 1, 0))).GetComponent<VoisterBehaviour>();//create botes
    ...
    public void SortNetworks()
    {
        ...
        networks.Sort();
        networks[populationSize - 1].Save("Assets/ModelSaveMove.txt");//saves networks weights and biases to file, to preserve network performance
